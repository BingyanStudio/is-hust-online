      ...
      <template v-if="site">
        ...
        <template v-if="clientGroups.length > 0">
          ...
          <el-tabs v-model="activeTab">
            ...
            >
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px; padding: 12px 16px; background: #f9fafb; border-radius: 6px; overflow: hidden;">
                <div style="flex: 1; min-width: 0;">
                  <div style="font-weight: 500; font-size: 15px; overflow-wrap: break-word;">{{ group.client.name }}</div>
                  <div style="font-size: 12px; color: #888; overflow-wrap: break-word;">{{ group.client.location || 'No location' }}</div>
                </div>
